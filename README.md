...
**Version:** 2.0.1 — see [CHANGELOG.md](CHANGELOG.md) for what changed and why.
...
- `questions.pdf` / `summary.pdf` are generated by `.claude/scripts/md_to_pdf.py` — regenerate after editing the markdown rather than editing the PDF directly
